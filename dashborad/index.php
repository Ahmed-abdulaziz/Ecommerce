            ...
            <div class="animated fadeIn">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    ...
                                    <a href="orders.php"> <div class="text-left dib">
                                            <div class="stat-text"><span class="count"><?php 
                                                $check = checkitem('id' , 'orders' , 'WHERE status = 1');
                                                echo $check;
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                       <a href="users.php?do=pending"> <div class="text-left dib">
                                            <div class="stat-text"><span class="count">
                                            <?php
                                                $check = checkitem('*' , 'users' , 'WHERE state = 0');
                                                echo $check;
                                            ?></span></div>
                                            <div class="stat-heading">Pending Users</div>
                                        </div></a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body--">
                                    <div class="table-stats order-table ov-h">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <?php $rows = selectall('*' , 'orders' , 'WHERE status = 1');
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="box-title">Last Users</h4>
                                <div class="calender-cont widget-calender">
                                    <ul class="list-group">
                                    <?php
                                            $rows = selectall('*' , 'users' , ' WHERE state = 1 ORDER BY id DESC limit 4 ');
                                        ...
                                        <table class="table table-hover">
                                             ...
                                             <?php   foreach($rows as $row){?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                        <a href="action.php?do=delete&table=users&id=<?php echo $row['id'];?>">  <button class="btn btn-danger">remove</button></a>
                                                        </td>
